...
def try_methods():
    ...
    ###########################################################################
    sean=rg.SimpleTurtle('turtle')
    sean.pen=rg.Pen('brown',5)
    sean.forward(150)
    sean.left(90)
    sean.forward(50)
    sean.backward(100)
...
def try_methods_and_functions():
    ...
    ###########################################################################
    ruth=rg.SimpleTurtle('triangle')
    ruth.pen=rg.Pen('blue',5)
    ruth.backward(150)
    ruth.speed=1
    draw_many_squares(ruth,2,100,30)
    ruth.speed=5
    ruth.pen=rg.Pen('red',5)
    draw_many_squares(ruth,10,50,15)
    ruth.speed=100
    ruth.pen=rg.Pen('red',35)
    draw_many_squares(ruth, 8, 300, 60)
    ruth.pen=rg.Pen('black',3)
    ruth.backward(200)
    ruth.draw_circle(30)
    ruth.draw_square(50)
